...
export default class SiteAreaStorage {
  public static async addAssetsToSiteArea(tenant: Tenant, siteArea: SiteArea, assetIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'addAssetsToSiteArea');
    // Check Tenant
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'addAssetsToSiteArea', uniqueTimerID, assetIDs);
  }

  public static async removeAssetsFromSiteArea(tenant: Tenant, siteAreaID: string, assetIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'removeAssetsFromSiteArea');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Site Area provided?
    if (siteAreaID) {
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'removeAssetsFromSiteArea', uniqueTimerID, assetIDs);
  }

  public static async getSiteAreaImage(tenant: Tenant, id: string): Promise<Image> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'getSiteAreaImage');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Read DB
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'getSiteAreaImage', uniqueTimerID, siteAreaImageMDB);
    return {
  ...
  public static async saveSiteArea(tenant: Tenant, siteAreaToSave: SiteArea, saveImage = false): Promise<string> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'saveSiteArea');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Set
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'saveSiteArea', uniqueTimerID, siteAreaMDB);
  ...
  public static async getSiteAreas(tenant: Tenant,
    ...
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'getSiteAreas');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    ...
    if (dbParams.onlyRecordCount) {
      ...
      await Logging.traceEnd(tenant, MODULE_NAME, 'getSiteAreas', uniqueTimerID, siteAreasCountMDB);
      return {
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'getSiteAreas', uniqueTimerID, siteAreasMDB);
    // Ok
    return {
  ...
  public static async addChargingStationsToSiteArea(tenant: Tenant, siteArea: SiteArea, chargingStationIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'addChargingStationsToSiteArea');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Site provided?
    if (siteArea) {
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'addChargingStationsToSiteArea', uniqueTimerID, chargingStationIDs);
  }
  ...
  public static async removeChargingStationsFromSiteArea(tenant: Tenant, siteAreaID: string, chargingStationIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'removeChargingStationsFromSiteArea');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Site provided?
    if (siteAreaID) {
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'removeChargingStationsFromSiteArea', uniqueTimerID, chargingStationIDs);
  }
  ...
  public static async deleteSiteAreas(tenant: Tenant, siteAreaIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'deleteSiteAreas');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'deleteSiteAreas', uniqueTimerID, siteAreaIDs);
  }

  public static async deleteSiteAreasFromSites(tenant: Tenant, siteIDs: string[]): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'deleteSiteAreasFromSites');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'deleteSiteAreasFromSites', uniqueTimerID, siteIDs);
  }

  private static async saveSiteAreaImage(tenant: Tenant, siteAreaID: string, siteAreaImageToSave: string): Promise<void> {
    // Debug
    const uniqueTimerID = Logging.traceStart(tenant, MODULE_NAME, 'saveSiteAreaImage');
    // Check Tenant
    DatabaseUtils.checkTenantObject(tenant);
    // Modify
    ...
    // Debug
    await Logging.traceEnd(tenant, MODULE_NAME, 'saveSiteAreaImage', uniqueTimerID, siteAreaImageToSave);
  }
}
